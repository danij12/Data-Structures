...
class List:
    ...
    def find(self, key):
        ...
        -------------------------------------------------------
        """
        previus, current, index = self._linear_search(key)
        if index > -1:
    ...
    def clean(self):
        ...
        while curr != None:
            if self.count(curr._value) > 1:
                previous, current,index = self._linear_search(curr._value)
                while self.count(curr._value) != 1:
                    previous._next = current._next
            curr = curr._next
